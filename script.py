...
part_2 = [
    Dialogue("You are a soldier in the British army during World War 2, and you discover that one of your fellow soldiers is planning to desert", BATTLEFIELD_2_BG),
    Dialogue(
        'What do you do? ',
        BATTLEFIELD_1_BG, ["Report the soldier to your superior officer3",
    ...
    Dialogue("You are a pilot during the Battle of Britain and your plane has been hit", GERMAN_ROOM_BG),
    Dialogue("Do you eject and risk being captured by the enemy or try to make a crash landing on friendly territory?", PRISON_1_BG, ["Eject immediately to ensure your own safety4",
    ...
    Dialogue("Meanwhile in USSR",COUNCIL_ROOM_BG),
    ...
    Dialogue("Hitler has officially declared operation Barbarossa", BATTLEFIELD_2_BG),
    Dialogue("The German army's offense was unexpected and not something we were prepared for… They have acquired considerable land and are moving towards the capital", BATTLEFIELD_2_BG),
    Dialogue("Our intelligence report says that the German army is not prepared for the Soviet Winters and we can use that to our advantage. Although a defensive approach means a massive loss of manpower and innocent lives", BATTLEFIELD_2_BG),
    Dialogue("What should our counter response be?",
             BATTLEFIELD_2_BG, ["Defend the capital, and wait for the Winters5",
                               "Launch an immediate all out offense5"]),
    
    Dialogue("The city of Leningrad has been surrounded by the German Forces cutting off supply with the soviet main-land as well as the relief forces", BATTLEFIELD_1_BG),
    Dialogue("As the local government, we can either wait for the central government support but that may be months away and may lead to disaster within the city or evacuate civilians out of the city but that would mean risking volunteer and civilian lives", BATTLEFIELD_1_BG),
    Dialogue("What would your next step be?",
             BATTLEFIELD_2_BG, ["You can either evacuate them to some safe place for their betterment4",
                               "Hold on till backing from the government4"]),
    
    Dialogue("You are a pharmacist in Leningrad, it is captured by German Forces and there's a shortage of day-to-day commodities", BATTLEFIELD_1_BG),
    Dialogue("You have access to a limited supply of medicine. The medicine could be sold on the black market for a large profit.", BATTLEFIELD_1_BG),
    Dialogue("What do you do?",
             BATTLEFIELD_2_BG, ["Sell the medicine on the black market to benefit yourself and your family3",
    ...
    Dialogue("Normandy Landings, June 6th, 1944 ...",BATTLEFIELD_1_BG),
    Dialogue("As a commander of French troops during the D-Day invasion, you are faced with unfavorable weather conditions that could jeopardize the success of the mission", BATTLEFIELD_1_BG),
    Dialogue("What do you do? ",
             BATTLEFIELD_2_BG, ["Delay the invasion until weather conditions improve5",
    ...
    Dialogue("You are in charge of a unit of soldiers during the D-Day invasion", BATTLEFIELD_1_BG),
    Dialogue("Do you?",
             BATTLEFIELD_2_BG, ["lead from the front and risk your own life alongside your troops5",
                               "Remain in the rear and direct from a safe distance5"]),
    Dialogue("You are part of a group of soldiers who discover a group of Jewish refugees hiding from the Nazis", BATTLEFIELD_1_BG),
    Dialogue("Do you?",
             BATTLEFIELD_2_BG, ["Risk your own safety to help them escape1",
                               "Ignore and continue on your mission1"]),
    Dialogue("Meanwhile in America",COUNCIL_ROOM_BG),
    ...
    Dialogue("Should we help them? But it would also mean a reduction in our troop forces",
             BATTLEFIELD_2_BG, ["They are a part of our coalition, send troops immediately4",
                               "We need the troops for our own expeditions4"]),
    Dialogue("You are an American soldier during World War II. You witness your fellow soldier commit a war crime against innocent civilians.", BATTLEFIELD_1_BG),
    #Dialogue("Colombia has been an exporter of Petroleum products to the Allied power. But helping Colombia at this stage will lead to a significant reduction of our forces in the warfronts of the UK, Japan, Australia, Argentina, France etc.", BATTLEFIELD_1_BG),
    Dialogue("Do you report the war crime and risk being punished, keep quiet and protect your own safety, or participate in the war crime and follow orders?",
             BATTLEFIELD_2_BG, ["Report the war crime and risk being punished3",
                               "Keep quiet and protect your own safety3",
                               "Participate in war crime and follow orders3"]),
    #Dialogue("Recent German attacks on Colombie has led to a loss of a significant amount of their troops in their arsenal", BATTLEFIELD_1_BG),
    Dialogue("You are a member of the American Red Cross and have been sent to Europe to provide aid to soldiers during the war. You come across a wounded German soldier", BATTLEFIELD_1_BG),
    Dialogue("What will you do?",
             BATTLEFIELD_2_BG, ["Provide aid to the German soldier, regardless of their nationality1",
    ...
    Dialogue("What do you do?",
             BATTLEFIELD_2_BG, ["Support the decision to drop the bomb and follow orders2",
